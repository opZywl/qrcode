...
import { QrCodeIcon as ScanQrCode, ScanLine, HistoryIcon, Info, RefreshCw } from "lucide-react"
    ...
    return (
      <>
        <div className="flex flex-col h-screen bg-background">
          ...
          {/* Área Central - Preview do QR Code */}
          ...
          {/* Botão Gerar QR Code Fixo - MESMO VISUAL DO DESKTOP */}
      ...
      <div className="flex flex-col items-center justify-center min-h-screen p-2 sm:p-4 bg-background">
        <Card className="w-full max-w-lg shadow-2xl">
          ...
          <div className="px-4 sm:px-6 pb-2 flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-4 mb-4">
            <Button
              variant="outline"
              className="w-full sm:w-auto hover:shadow-primary-glow focus:shadow-primary-glow hover:border-primary focus:border-primary"
              onClick={() => onScannerAbertoChange(true)}
            >
              <ScanLine className="w-5 h-5 mr-2 animate-text-glow-primary" />
              Escanear QR Code
            </Button>
            <Button
              variant="outline"
              ...
              onClick={() => onHistoricoAbertoChange(true)}
            >
              <HistoryIcon className="w-5 h-5 mr-2 animate-text-glow-primary" />
              Ver Histórico
            </Button>
          </div>
