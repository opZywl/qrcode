  ...
  return (
      ...
      >
        ...
        <CardContent className="p-3 pt-0">
          <p className="text-sm text-card-foreground mb-3">Confira meu portfólio para ver mais projetos incríveis!</p>
          <Button
              variant="outline"
              className="w-full group hover:bg-primary/10 hover:border-primary bg-transparent"
